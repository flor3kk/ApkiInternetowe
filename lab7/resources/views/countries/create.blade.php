            ...
            <div class="col-6">
                <form method="POST" action="{{ route('countries.store') }}" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="area" name="area" type="text" class="form-control @if ($errors->first('area')) is-invalid @endif" value="{{ old('area') }}">
                        <div class="invalid-feedback">Nieprawidlowa Powierzchnia</div>
                    </div>

                    {{-- Uzupełnienie formularza o brakujące pole --}}
                    <div class="form-group mb-2">
